...
class MMapIndexedDatasetBuilder(object):
    ...
    def add_item(self, np_array):
        ...
        # Removed line above and changed input arg to avoid roundtrip through torch.
...
def run_split(in_path, left_path, right_path, right_prob, right_max, seed):
    ...
    left_builder = MMapIndexedDatasetBuilder(data_file_path(left_path), dtype)
    right_builder = MMapIndexedDatasetBuilder(data_file_path(right_path), dtype)
    ...
    left_builder.finalize(index_file_path(left_path))
    right_builder.finalize(index_file_path(right_path))
